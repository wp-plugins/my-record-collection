...
function mrc_display($text) {
	...
	if (preg_match("|<!--MyRecordCollection-->|", $text)) {
		...
		if($mode == "simple"){
			...
			$posts = '<div id="MyRecordCollection"><p>Click on the cover to se more information about the record.</p><ul class="music">';
		}
		...
		$posts .= "</ul><p class=\"mrc_d_foot\">This record collection is based on data from discogs.com generated by the <b>My Record Collection</b> WordPress-plugin. Discogs is a trademark of Zink Media, Inc. My Record Collection-plugin is not affiliated with or endorsed by Zink Media, Inc. All images are copyright of their respective owners. Further entry data from the Discogs database is licensed in the public domain.</p></div>";
